...
# importing #################
#####
file1 = '/home/data/research/IIP/ML/colab/luciano/pedro/rawdata/data_all_algorithm.csv' # negative - N rows of 16 (features) complex number comma separated
file2 = '/home/data/research/IIP/ML/colab/daniel/rawdata/d2_PPT.txt' # positive - M rows of 16 complex number comma separated

data = np.genfromtxt(file1,  delimiter=',',dtype=str, header = True) # load positive
...
neurons = [800, 400]                                                     # neurons per layer
